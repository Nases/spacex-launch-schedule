...
export default ({
  ...
  return (
    <tr className='hover:bg-gray-200'>
      <td className="px-2 sm:px-6 sm:py-4 whitespace-no-wrap border-b border-gray-200">
      ...
      <td className="px-2 sm:px-6 sm:py-4 whitespace-no-wrap border-b border-gray-200 text-center">
        <div className="text-sm leading-5 text-gray-500">{launch_date}</div>
      </td>
      <td className="px-2 sm:px-6 sm:py-4 whitespace-no-wrap border-b border-gray-200 text-center tooltip">
        {
          (launch_success)
            ?
