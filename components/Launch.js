...
export default ({
  ...
  return (
    <tr className='hover:bg-gray-200'>
      <td className="sm:px-6 sm:py-4 whitespace-no-wrap border-b border-gray-200">
      ...
      <td className="hidden sm:table-cell px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-center">
        <div className="text-sm leading-5 text-gray-500">{launch_date}</div>
      </td>
      <td className="sm:px-6 sm:py-4 whitespace-no-wrap border-b border-gray-200 text-center tooltip">
        {
          (launch_success)
            ?
      ...
      <td className="sm:px-6 sm:py-4 whitespace-no-wrap border-b border-gray-200 text-center">
        {
          (youtubeVideo)
            ?
