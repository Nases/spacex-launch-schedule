        ...
        <div className="overflow-x-auto">
          <div className="align-middle inline-block min-w-full shadow overflow-hidden rounded-lg border-b border-gray-200">
            <div className='text-gray-900 bg-gray-100 pt-4 px-6'>
              ...
              <p>At SpaceX Launch Schedule, accessible from spacexschedule.com, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by SpaceX Launch Schedule and how we use it.</p>
